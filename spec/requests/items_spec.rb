...
RSpec.describe "Items API" do
  ...
  describe "POST /todos/:todo_id/items" do
    let(:valid_attributes) { { name: "Study RSpec", done: false }.to_json }
  ...
  describe "PUT /todos/:todo_id/items/:id" do
    let(:valid_attributes) { { name: "Study Factory Girl" }.to_json }
    ...
    context "when item exists" do
      ...
      it "updates the item" do
        ...
        expect(updated_item.name).to match(/Study Factory Girl/)
      end
    end
